...
class StandaloneTextDiffer(qt.QWidget):
    ...
    def __init__(
        self, parent, text_1=None, text_2=None, text_1_name="", text_2_name=""
    ):
        """Initialization."""
        ...
        self.editor_1 = gui.forms.customeditor.CustomEditor(
            self, parent, enable_event_filter=False
        )
        self.init_editor(self.editor_1)
        self.editor_2 = gui.forms.customeditor.CustomEditor(
            self, parent, enable_event_filter=False
        )
        self.init_editor(self.editor_2)
        self.editor_1.choose_lexer("text")
        self.editor_2.choose_lexer("text")
        self.label_1 = gui.templates.widgetgenerator.create_label(
            text=self.text_1_name,
            alignment=qt.Qt.AlignmentFlag.AlignHCenter
            | qt.Qt.AlignmentFlag.AlignVCenter,
        )
        self.label_2 = gui.templates.widgetgenerator.create_label(
            text=self.text_2_name,
            alignment=qt.Qt.AlignmentFlag.AlignHCenter
            | qt.Qt.AlignmentFlag.AlignVCenter,
        )
        self.gb_1 = gui.templates.widgetgenerator.create_groupbox_with_layout(
            name="groupbox-1",
            borderless=True,
        )
        self.gb_1.layout().addWidget(self.label_1)
        self.gb_1.layout().addWidget(self.editor_1)
        self.gb_2 = gui.templates.widgetgenerator.create_groupbox_with_layout(
            name="groupbox-2",
            borderless=True,
        )
        self.gb_2.layout().addWidget(self.label_2)
        self.gb_2.layout().addWidget(self.editor_2)
        self.splitter.addWidget(self.gb_1)
        self.splitter.addWidget(self.gb_2)
    ...
    def _init_editor_functions(self):
        ...
        def uniplemented_function(*args, **kwargs):
            # print("Function '{:s}' is not implemented by the TextDiffer!".format(args[0]))
            pass
    ...
    def compare(self, text_1, text_2):
        ...
        if any(line_styling_1) == False and any(line_styling_2) == False:
            print("No differences between texts.")
        else:
    ...
    def find_next_unique_1(self):
        ...
        if next_unique_diff_line == 0:
            print("Scrolled back to the start of the document!")
    ...
    def set_theme(self, theme):
        self.editor_1.set_theme(data.theme)
        self.editor_1.choose_lexer("text")
        self.editor_2.set_theme(data.theme)
        self.editor_2.choose_lexer("text")
