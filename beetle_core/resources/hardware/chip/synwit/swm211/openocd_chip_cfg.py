...
if { [info exists FLASHLOADER] } {
    ...
    set _FLASHLOADER ../flm/synwit/SWM211x8.FLM
}
set _FLASHNAME $_CHIPNAME.flash
flash bank $_FLASHNAME cmsis_flash 0x00000000 $_FLASH_SIZE 0 0 $_TARGETNAME $_FLASHLOADER 0x100
