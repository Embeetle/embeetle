...
class LiburlItem(_da_.File):
    class Status(_da_.File.Status):
        __slots__ = ()

        def __init__(self, item: LiburlItem) -> None:
            """"""
        ...
        def sync_state(
            ...
            def sync_self(*args) -> None:
                ...
                self.closedIconpath = "icons/tool_cards/card_world.png"
                self.openIconpath = "icons/tool_cards/card_world.png"
    ...
    def __init__(
        ...
        """Create a LiburlItem()-instance for the dashboard, to represent the
        url of a specific library.
        ...
        super().__init__(
            ...
            rootdir=rootdir,
            parent=parent,
            name=libobj.get_web_url().lower(),
            state=LiburlItem.Status(item=self),
        )
