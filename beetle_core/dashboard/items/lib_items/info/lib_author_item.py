...
class LibauthorItem(_da_.File):
    class Status(_da_.File.Status):
        __slots__ = ()

        def __init__(self, item: LibauthorItem) -> None:
            """"""
        ...
        def sync_state(
            ...
            def sync_self(*args):
                ...
                author = author.replace(">", "&#62;")
                lbltext = "author:".ljust(15, "^") + author
    ...
    def __init__(
        ...
        """Create a LibauthorItem()-instance for the dashboard, to represent the
        author of a specific library.
        ...
        super().__init__(
            ...
            rootdir=rootdir,
            parent=parent,
            name=libobj.get_author().lower(),
            state=LibauthorItem.Status(item=self),
        )
